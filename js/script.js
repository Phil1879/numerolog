...
const translations = {
    ru: {
        ...
        "modal-privacy-section-1-title": "1. ОБЩИЕ ПОЛОЖЕНИЯ",
        "modal-privacy-section-1-text": "1.1. Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных клиентов.",
        "modal-privacy-section-2-title": "2. СБОР ПЕРСОНАЛЬНЫХ ДАННЫХ",
        "modal-privacy-section-2-text": "2.1. Мы собираем следующие персональные данные:",
        "modal-privacy-section-2-item-1": "ФИО",
        "modal-privacy-section-2-item-2": "Дата рождения",
        "modal-privacy-section-2-item-3": "Контактная информация (телефон, email)",
        "modal-privacy-section-2-item-4": "Информация, предоставленная в ходе консультаций",
        "modal-privacy-section-3-title": "3. ИСПОЛЬЗОВАНИЕ ПЕРСОНАЛЬНЫХ ДАННЫХ",
        "modal-privacy-section-3-text": "3.1. Персональные данные используются исключительно для:",
        "modal-privacy-section-3-item-1": "Оказания услуг по цифровой родологии",
        "modal-privacy-section-3-item-2": "Связи с клиентом",
        "modal-privacy-section-3-item-3": "Улучшения качества обслуживания",
        "modal-privacy-section-4-title": "4. ЗАЩИТА ПЕРСОНАЛЬНЫХ ДАННЫХ",
        "modal-privacy-section-4-text": "4.1. Мы применяем все необходимые меры для защиты ваших персональных данных от несанкционированного доступа, изменения, раскрытия или уничтожения.",
        "modal-privacy-section-5-title": "5. КОНФИДЕНЦИАЛЬНОСТЬ",
        "modal-privacy-section-5-text": "5.1. Вся информация, полученная в ходе консультаций, является строго конфиденциальной и не передается третьим лицам без вашего согласия.",
        "modal-privacy-section-6-title": "6. ПРАВА КЛИЕНТА",
        "modal-privacy-section-6-text": "6.1. Вы имеете право:",
        "modal-privacy-section-6-item-1": "Получать информацию о ваших персональных данных",
        "modal-privacy-section-6-item-2": "Требовать исправления неточных данных",
        "modal-privacy-section-6-item-3": "Требовать удаления ваших данных",
        "modal-privacy-section-7-title": "7. КОНТАКТНАЯ ИНФОРМАЦИЯ",
        "modal-privacy-section-7-company": "ФОП Колєсніченко Вероніка Євгенівна",
        "modal-privacy-section-7-rnokpp": "РНОКПП: 2659804849",
        "modal-privacy-section-7-email": "E-mail: veronika@zadorozhnaya.com",

        "modal-terms-title": "Публичная оферта",
        "modal-terms-subtitle": "Договор оказания услуг",
        "modal-terms-section-1-title": "1. ПРЕДМЕТ ДОГОВОРА",
        "modal-terms-section-1-text": "1.1. Исполнитель обязуется оказать Заказчику услуги по цифровой родологии, консультированию и трансформационным практикам (далее - Услуги), а Заказчик обязуется принять и оплатить эти услуги.",
        "modal-terms-section-2-title": "2. ПРАВА И ОБЯЗАННОСТИ СТОРОН",
        "modal-terms-section-2-subtitle-1": "2.1. Исполнитель обязуется:",
        "modal-terms-section-2-item-1": "Оказать услуги качественно и в согласованные сроки",
        "modal-terms-section-2-item-2": "Сохранять конфиденциальность информации Заказчика",
        "modal-terms-section-2-item-3": "Проводить консультации в согласованном формате",
        "modal-terms-section-2-subtitle-2": "2.2. Заказчик обязуется:",
        "modal-terms-section-2-item-4": "Своевременно оплатить услуги",
        "modal-terms-section-2-item-5": "Предоставить необходимую информацию для консультации",
        "modal-terms-section-2-item-6": "Соблюдать назначенное время консультаций",
        "modal-terms-section-3-title": "3. СТОИМОСТЬ И ПОРЯДОК ОПЛАТЫ",
        "modal-terms-section-3-text-1": "3.1. Стоимость услуг определяется согласно действующему прайс-листу на момент заказа.",
        "modal-terms-section-3-text-2": "3.2. Оплата производится предварительно на реквизиты Исполнителя.",
        "modal-terms-section-4-title": "4. ОТВЕТСТВЕННОСТЬ СТОРОН",
        "modal-terms-section-4-text": "4.1. За неисполнение или ненадлежащее исполнение обязательств стороны несут ответственность в соответствии с законодательством Украины.",
        "modal-terms-section-5-title": "5. РЕКВИЗИТЫ ИСПОЛНИТЕЛЯ",
        "modal-terms-section-5-company": "Фізична особа-підприємець Колєсніченко Вероніка Євгенівна",
        "modal-terms-section-5-rnokpp": "РНОКПП: 2659804849",
        "modal-terms-section-5-address": "Адреса: Україна, 65062, Одеська обл., м. Одеса, вул. Педагогічна, 6. 23-Б, кв.15",
        "modal-terms-section-5-email": "E-mail: veronika@zadorozhnaya.com",
    ...
    uk: {
        ...
        "modal-privacy-section-1-title": "1. ЗАГАЛЬНІ ПОЛОЖЕННЯ",
        "modal-privacy-section-1-text": "1.1. Ця Політика конфіденційності визначає порядок обробки та захисту персональних даних клієнтів.",
        "modal-privacy-section-2-title": "2. ЗБИРАННЯ ПЕРСОНАЛЬНИХ ДАНИХ",
        "modal-privacy-section-2-text": "2.1. Ми збираємо такі персональні дані:",
        "modal-privacy-section-2-item-1": "ПІБ",
        "modal-privacy-section-2-item-2": "Дата народження",
        "modal-privacy-section-2-item-3": "Контактна інформація (телефон, email)",
        "modal-privacy-section-2-item-4": "Інформація, надана під час консультацій",
        "modal-privacy-section-3-title": "3. ВИКОРИСТАННЯ ПЕРСОНАЛЬНИХ ДАНИХ",
        "modal-privacy-section-3-text": "3.1. Персональні дані використовуються виключно для:",
        "modal-privacy-section-3-item-1": "Надання послуг з цифрової родології",
        "modal-privacy-section-3-item-2": "Зв'язку з клієнтом",
        "modal-privacy-section-3-item-3": "Покращення якості обслуговування",
        "modal-privacy-section-4-title": "4. ЗАХИСТ ПЕРСОНАЛЬНИХ ДАНИХ",
        "modal-privacy-section-4-text": "4.1. Ми застосовуємо всі необхідні заходи для захисту ваших персональних даних від несанкціонованого доступу, зміни, розкриття або знищення.",
        "modal-privacy-section-5-title": "5. КОНФІДЕНЦІЙНІСТЬ",
        "modal-privacy-section-5-text": "5.1. Вся інформація, отримана під час консультацій, є суворо конфіденційною і не передається третім особам без вашої згоди.",
        "modal-privacy-section-6-title": "6. ПРАВА КЛІЄНТА",
        "modal-privacy-section-6-text": "6.1. Ви маєте право:",
        "modal-privacy-section-6-item-1": "Отримувати інформацію про ваші персональні дані",
        "modal-privacy-section-6-item-2": "Вимагати виправлення неточних даних",
        "modal-privacy-section-6-item-3": "Вимагати видалення ваших даних",
        "modal-privacy-section-7-title": "7. КОНТАКТНА ІНФОРМАЦІЯ",
        "modal-privacy-section-7-company": "ФОП Колєсніченко Вероніка Євгенівна",
        "modal-privacy-section-7-rnokpp": "РНОКПП: 2659804849",
        "modal-privacy-section-7-email": "E-mail: veronika@zadorozhnaya.com",

        "modal-terms-title": "Публічна оферта",
        "modal-terms-subtitle": "Договір надання послуг",
        "modal-terms-section-1-title": "1. ПРЕДМЕТ ДОГОВОРУ",
        "modal-terms-section-1-text": "1.1. Виконавець зобов'язується надати Замовнику послуги з цифрової родології, консультування та трансформаційних практик (далі - Послуги), а Замовник зобов'язується прийняти та оплатити ці послуги.",
        "modal-terms-section-2-title": "2. ПРАВА ТА ОБОВ'ЯЗКИ СТОРІН",
        "modal-terms-section-2-subtitle-1": "2.1. Виконавець зобов'язується:",
        "modal-terms-section-2-item-1": "Надати послуги якісно та у погоджені терміни",
        "modal-terms-section-2-item-2": "Зберігати конфіденційність інформації Замовника",
        "modal-terms-section-2-item-3": "Проводити консультації у погодженому форматі",
        "modal-terms-section-2-subtitle-2": "2.2. Замовник зобов'язується:",
        "modal-terms-section-2-item-4": "Своєчасно оплатити послуги",
        "modal-terms-section-2-item-5": "Надати необхідну інформацію для консультації",
        "modal-terms-section-2-item-6": "Дотримуватися призначеного часу консультацій",
        "modal-terms-section-3-title": "3. ВАРТІСТЬ ТА ПОРЯДОК ОПЛАТИ",
        "modal-terms-section-3-text-1": "3.1. Вартість послуг визначається згідно з чинним прайс-листом на момент замовлення.",
        "modal-terms-section-3-text-2": "3.2. Оплата провадиться попередньо на реквізити Виконавця.",
        "modal-terms-section-4-title": "4. ВІДПОВІДАЛЬНІСТЬ СТОРІН",
        "modal-terms-section-4-text": "4.1. За невиконання або неналежне виконання зобов'язань сторони несуть відповідальність відповідно до законодавства України.",
        "modal-terms-section-5-title": "5. РЕКВІЗИТИ ВИКОНАВЦЯ",
        "modal-terms-section-5-company": "Фізична особа-підприємець Колєсніченко Вероніка Євгенівна",
        "modal-terms-section-5-rnokpp": "РНОКПП: 2659804849",
        "modal-terms-section-5-address": "Адреса: Україна, 65062, Одеська обл., м. Одеса, вул. Педагогічна, 6. 23-Б, кв.15",
        "modal-terms-section-5-email": "E-mail: veronika@zadorozhnaya.com",
